...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Комплектация коммерческих объектов сантехникой и керамогранитом | STURM",
    description:
      "Проектные поставки сантехники, плитки, керамогранита и интерьерных решений для гостиниц, ресторанов, бизнес-центров, медицинских, спортивных и жилых объектов.",
    url: "/",
    siteName: "STURM",
    images: [
      {
